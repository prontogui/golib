...
func getBogeyEventTimestampProvider() EventTimestampProvider {
	return _bogeyEventTimestampProvider
}

func _bogeyEventTimestampProvider() time.Time {
	return time.Now()
}
