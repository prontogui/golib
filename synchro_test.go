...
func Test_FullUpdate(t *testing.T) {
	...
	s := NewSynchro()
	s.SetTopPrimitives(getBogeyEventTimestampProvider(), &SimplePrimitive{})
...
func Test_PartialUpdate1(t *testing.T) {
	...
	s := NewSynchro()
	s.SetTopPrimitives(getBogeyEventTimestampProvider(), cmd1, cmd2, cmd3)
...
func Test_IngestFullUpdateNotSupported(t *testing.T) {
	...
	s1 := NewSynchro()
	s1.SetTopPrimitives(getBogeyEventTimestampProvider(), cmd1, cmd2, cmd3)
...
func Test_IngestPartialUpdateMultiplePrimitivesNotSupported(t *testing.T) {
	...
	s2 := NewSynchro()
	s2.SetTopPrimitives(getBogeyEventTimestampProvider(), &SimplePrimitive{}, &SimplePrimitive{}, &SimplePrimitive{})
...
func Test_IngestPartialUpdate(t *testing.T) {
	...
	s1 := NewSynchro()
	s1.SetTopPrimitives(getBogeyEventTimestampProvider(), cmd1, cmd2)
	...
	s2 := NewSynchro()
	s2.SetTopPrimitives(getBogeyEventTimestampProvider(), &SimplePrimitive{}, &SimplePrimitive{})
